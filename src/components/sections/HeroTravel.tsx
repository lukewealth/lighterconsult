...
export const HeroTravel = () => {
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-white flex items-center pt-20 pb-12">
      {/* Dynamic Background Shapes from Travels Page Sample */}
      <div className="absolute top-0 right-0 w-[60%] h-full bg-blue-50/50 rounded-l-[200px] -z-10 transform translate-x-20 hidden lg:block" />
      <div className="absolute top-20 left-20 w-32 h-32 border-4 border-blue-100 rounded-full -z-10 animate-pulse hidden lg:block" />

      <div className="max-w-[1400px] mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <ScrollReveal direction="left" className="relative order-2 lg:order-1">
          <div className="relative w-full aspect-square max-w-[500px] md:max-w-[600px] mx-auto">
            ...
            <div className="absolute inset-0 border-[15px] md:border-[20px] border-blue-600/10 rounded-full" />
            <div className="absolute inset-[30px] md:inset-[40px] rounded-full overflow-hidden shadow-2xl bg-slate-100">
              <Image 
            ...
            <motion.div 
              ...
              className="absolute top-[10%] -right-4 md:-right-10 bg-white p-4 md:p-6 rounded-2xl md:rounded-3xl shadow-xl border border-slate-50 z-20 flex items-center gap-3 md:gap-4"
            >
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-blue-600 flex items-center justify-center text-white">
                <Globe size={20} className="md:size-6" />
              </div>
              <div>
                <p className="text-[8px] md:text-[10px] font-bold text-slate-400 uppercase tracking-wider">Top Destination</p>
                <p className="text-sm md:text-lg font-black text-slate-900 leading-tight">Toronto, Canada</p>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute bottom-[10%] -left-4 md:-left-10 bg-white p-4 md:p-6 rounded-2xl md:rounded-3xl shadow-xl border border-slate-50 z-20 flex items-center gap-3 md:gap-4"
            >
              ...
              <div>
                <p className="text-[8px] md:text-[10px] font-bold text-slate-400 uppercase tracking-wider">Happy Travelers</p>
                <p className="text-sm md:text-lg font-black text-slate-900 leading-tight">500+ Relocated</p>
              </div>
            </motion.div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal direction="right" className="flex flex-col gap-6 md:gap-8 order-1 lg:order-2 pt-12 md:pt-0">
          ...
          <div className="bg-slate-50 p-6 md:p-8 rounded-[32px] md:rounded-[40px] border border-slate-100 shadow-sm space-y-6 md:space-y-8 mt-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4 w-full sm:w-auto">
                <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white shadow-lg shadow-blue-100 font-black shrink-0">1</div>
                <div>
              ...
              <Button href="/travel/book-now" size="lg" className="rounded-2xl px-10 bg-blue-600 text-white shadow-xl shadow-blue-100 group w-full sm:w-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 md:gap-8 pt-4">
            <Link href="/travel/book-now" className="flex items-center gap-3 group w-full sm:w-auto justify-center sm:justify-start">
            ...
            <p className="text-[10px] text-slate-400 max-w-[200px] font-bold uppercase tracking-widest leading-relaxed text-center sm:text-left">
