      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mt-16 text-center">
          <p className="text-slate-400 text-sm font-bold uppercase tracking-widest">
            All prices are in USD. <span className="text-blue-600 underline cursor-pointer hover:text-amber transition-colors">Currency conversion applied at checkout.</span>
          </p>
        </div>
      </div>
              ...
              {formStatus === 'success' ? (
                ...
                <>
                  <div className="mb-10">
                    ...
                    <p className="text-slate-500 mt-2">Cost Estimate: <span className="text-slate-900 font-bold">${selectedPlan.price}</span>/month</p>
                  </div>
