...
const footerLinks = [
  ...
  },
  {
    ...
    links: [
      { name: "Social Media Management", href: "/consult" },
      { name: "Content Creation", href: "/consult" },
      { name: "Paid Advertising", href: "/consult" },
      { name: "Digital Strategy", href: "/consult" },
    ],
  },
];
