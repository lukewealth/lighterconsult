...
import { ShoppingBag, TrendingUp, Target, BarChart2, ShieldCheck, ArrowRight } from "lucide-react";
import { Metadata } from "next";
import Image from "next/image";

export const metadata: Metadata = {
  title: "E-commerce Scale Use Case",
  description: "Automated ROI tracking and audience segmentation for retail brands. Scaling high-performance e-commerce stores in Nigeria and across Africa.",
};

export default function EcommerceScalePage() {
  const stats = [
  ...
  const features = [
    {
      title: "Automated ROI Tracking",
      desc: "Real-time visibility into your ad spend versus revenue. No more guessing.",
      icon: BarChart2
    },
    {
      title: "Audience Segmentation",
      desc: "Surgical precision targeting based on purchase intent and buying power.",
      icon: Target
    },
    {
      title: "Inventory-Led Ads",
      desc: "Dynamically promote products that are in stock and ready to ship.",
      icon: ShoppingBag
    }
  ];
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-40 pb-24 px-6 bg-slate-50 border-b border-slate-100">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left">
            <span className="t-label text-blue-600 mb-6 block tracking-[4px]">USE CASE · RETAIL</span>
            <h1 className="t-display text-slate-900 mb-8 md:text-8xl">E-commerce<br/><span className="text-blue-600 italic font-serif">Scale.</span></h1>
            <p className="t-body-lg text-slate-500 max-w-[540px]">
              Automated ROI tracking and audience segmentation for retail brands. Scaling high-performance e-commerce stores with precision data.
            </p>
          ...
          <ScrollReveal direction="right" className="relative">
             <div className="aspect-square rounded-[60px] bg-white overflow-hidden relative shadow-2xl border-[12px] border-white group">
                <Image 
                  src="/assets/portfolio/okwara-1.png" 
      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-[900px] mx-auto bg-white p-12 md:p-20 rounded-[64px] shadow-2xl border border-slate-100 relative overflow-hidden">
           ...
           <ScrollReveal>
              <h2 className="t-h1 text-slate-900 mb-8 leading-tight italic font-serif">The Growth<br/>Methodology.</h2>
              <div className="space-y-8">
                 <div className="flex gap-6">
                    <div className="text-blue-600 font-black text-4xl">01</div>
                    <div>
                       <h4 className="text-lg font-black text-slate-900 mb-2 uppercase">Data Audit</h4>
                       <p className="text-slate-500">We first clean and verify your tracking pixels to ensure 100% data accuracy across Meta, Google, and TikTok.</p>
                    </div>
                 </div>
                 <div className="flex gap-6">
                    <div className="text-blue-600 font-black text-4xl">02</div>
                    <div>
                       <h4 className="text-lg font-black text-slate-900 mb-2 uppercase">System Deployment</h4>
                       <p className="text-slate-500">Automated reporting dashboards that connect your ads directly to your Shopify or WooCommerce sales data.</p>
                    </div>
                 </div>
                 <div className="flex gap-6">
                    <div className="text-blue-600 font-black text-4xl">03</div>
                    <div>
                       <h4 className="text-lg font-black text-slate-900 mb-2 uppercase">Scale & Optimize</h4>
                       <p className="text-slate-500">Aggressive scaling of winning creatives and audience segments to maximize daily revenue.</p>
                    </div>
                 </div>
              </div>
